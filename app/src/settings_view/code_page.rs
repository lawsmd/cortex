...
const CODEBASE_INDEX_DESCRIPTION: &str = "Cortex can automatically index code repositories as you navigate them, helping agents quickly understand context and provide solutions. Code is never stored on the server. If a codebase is unable to be indexed, Cortex can still navigate your codebase and gain insights via grep and find tool calling.";
...
const AUTO_INDEX_DESCRIPTION: &str = "When set to true, Cortex will automatically index code repositories as you navigate them - helping agents quickly understand context and provide targeted solutions.";
