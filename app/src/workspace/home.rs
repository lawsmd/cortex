...
const WARP_HOME_TITLE: &str = "Welcome to Cortex on Web";
const WARP_HOME_CONTENT: &str = r#"
Welcome to Cortex on Web - your browser-based home for Cortex!
Use Cortex on Web to:
* Join Shared Sessions
* Create, View, and Edit Warp Drive Objects
* Manage your Warp Settings

Cortex on Web can also be used by your teammates and peers who don't have Cortex downloaded yet to view your shared sessions, notebooks, and workflows."#;
