...
impl View for WasmNUXDialog {
    ...
    fn render(&self, app: &AppContext) -> Box<dyn Element> {
        ...
        let dialog = if self.requested_download {
            Dialog::new(
                "Open in Cortex Desktop?".to_string(),
            ...
            Dialog::new("Download Cortex Desktop?".to_string(), None, dialog_styles)
                .with_child(
                    Flex::column()
                        ...
                        .with_child(
                            appearance
                                .ui_builder()
                                .span("Cortex is the intelligent terminal with AI and your dev team's knowledge built-in.")
